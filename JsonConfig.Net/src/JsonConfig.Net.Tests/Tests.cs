...
namespace JsonConfig.Net.Tests
{
	...
	public class BunchOfTests : BaseTest
	{
		...
		public void FirewallConfig ()
		{
			...
			var interfaces = merged.Interfaces as ICollection<object>;
		...
		[Test,Ignore("Runnig the tests using dotnet-test-nunit dll")]
		...
		public void ComplexTypeWithArray ()
		{
			...
			Assert.IsInstanceOf<IList<object>>(result.Types);
		}
		[Test]
